...
<br>   
        ...
        <form name="form1" action="" method="post">
            <div class="row">
                ...
                <div class="col-9" align="right">           
                      <a href="/~four12/p_ledger/add<?=$tmp;?>" class="btn btn-sm mycolor1">추가</a>
                </div>
            </div>
        </form>
        ...
        <table class="table table-bordered table-sm mymargin5">
            ...
            <tr>
                <td><?= $no; ?></td>
                <td><?= $row->date12 ?></td>
                <td align="left"><a href="/~four12/p_ledger/view/no/<?=$no?><?=$tmp?>"><?=$row->product_name?></a></td>
                <td align="right"><?= number_format($row->price12) ?></td>
                <td align="right"><?= number_format($row->pq12) ?></td>
        ...
        function find_text() {
            form1.action = "/~four12/p_ledger/lists/text1/" + form1.text1.value;
            form1.submit();
        }
