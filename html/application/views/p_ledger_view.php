...
<form name="form1" method="p_ledger_insert.html">
    <?
        $no = $row->no12;
    ?>
    ...
    <div align="center">
        <a href="/~four12/p_ledger/edit<?=$tmp?>" class="btn btn-sm mycolor1">수정</a>
        <a href="/~four12/p_ledger/del<?=$tmp?>" class="btn btn-sm mycolor1" onClick="return confirm('정말 삭제하시겠습니까?');">삭제</a>
