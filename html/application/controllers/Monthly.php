<?
    class Monthly extends CI_Controller {       // monthly클래스 선언
        ...
        public function lists() {
            ...
            $base_url = "/monthly/lists/text1/$text1/page"; // $page_segment = 6;
            ...
            $data["list"] = $this->monthly_m->getlist($text1); // 해당 페이지 자료 읽기
            $data["text1"] = $text1;
