<?
    class S_Ledger_m extends CI_Model     // 모델 클래스 선언
    {
        ...
        public function rowcount($text1) {
            $sql = "select * from ledger12 where type12 = 1 and date12 = '$text1'";
            return $this->db->query($sql)->num_rows();
        }

        public function getlist($text1, $start, $limit) {
            // select문 정의
            $sql = "select ledger12.*, product12.name12 as product_name from ledger12 left join product12 on ledger12.product_no12 = product12.no12 where ledger12.type12 = 1 and ledger12.date12 = '$text1'";
